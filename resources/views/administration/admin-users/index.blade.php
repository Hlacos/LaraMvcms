...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body no-padding">
            @include('lara-mvcms::administration.admin-users._table', ['admin-users' => $adminUsers])
        </div><!-- /.box-body -->
        <div class="box-footer">
            @include('lara-mvcms::partials._pager', ['items' => $adminUsers])
        </div>
    </div>
@stop
...
@section('page-header')
    <h1>
        {{ trans('lara-mvcms::admin-users.title') }}
    </h1>
@overwrite
