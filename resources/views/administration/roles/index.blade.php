...
@section('content')
    <div class="box box-primary">
        <div class="box-header">
            <div class="row">
                <div class="col-sm-6">
                    <form action="{{ route('lara-mvcms.administration.roles.index') }}" method="get" id="pager-form">
                        <select name="size">
                ...
                <div class="col-sm-6 text-right">
                    <a class="btn btn-flat btn-primary" href="{{ route('lara-mvcms.administration.roles.create') }}">
                        {{ trans('lara-mvcms::roles.buttons.create') }} <i class="fa fa-lock"></i>
                    </a>
                </div>
            </div>
        </div><!-- /.box-header -->
...
@section('breadcrumbs')
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-lock"></i> {{ trans('lara-mvcms::roles.title') }}</li>
    </ol>
@overwrite
